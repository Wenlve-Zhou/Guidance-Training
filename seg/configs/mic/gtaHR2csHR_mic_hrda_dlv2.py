...
_base_ = [
    ...
    '../_base_/models/deeplabv2red_r101.py',
...
name_architecture = 'hrda1-512-0.1_dlv2_sepaspp_sl_r101'
name_encoder = 'r101'
name_decoder = 'hrda1-512-0.1_dlv2_sepaspp_sl'
