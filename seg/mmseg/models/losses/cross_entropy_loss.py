...
def focal_loss(pred,
    ...
    Args:
        ...
        class_weight (list[float], optional): The weight for each class.
        ignore_index (int | None): The label index to be ignored. Default: 255
        gamma (float): The focal loss exponent (typically 2.0).
        alpha (float): The focal loss alpha parameter (typically 0.25).
    ...
    # pt = label * sigmoid_pred + (1 - label) * (1 - sigmoid_pred)
